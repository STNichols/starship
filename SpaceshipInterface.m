...
% SPACESHIPINTERFACE MATLAB code for SpaceshipInterface.fig
%      SPACESHIPINTERFACE, by itself, creates a new SPACESHIPINTERFACE or raises the existing
%      singleton*.
%
%      H = SPACESHIPINTERFACE returns the handle to a new SPACESHIPINTERFACE or the handle to
%      the existing singleton*.
%
%      SPACESHIPINTERFACE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SPACESHIPINTERFACE.M with the given input arguments.
%
%      SPACESHIPINTERFACE('Property','Value',...) creates a new SPACESHIPINTERFACE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SpaceshipInterface_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SpaceshipInterface_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SpaceshipInterface

% Last Modified by GUIDE v2.5 28-Feb-2019 19:47:57
